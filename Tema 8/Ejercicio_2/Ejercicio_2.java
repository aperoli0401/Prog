...
public class Ejercicio_2 {
	...
	public static void main(String[] args) {
		...
		//2
		List listaDesordenadas = new LinkedList();
		System.out.println(listaDesordenadas);
		
		//3
		Persona alejandro2 = new Persona();
		alejandro.setNombre("alex");
		Persona manuel2 = new Persona();
		Persona ernesto2 = new Persona();
		listaVacia.add(alejandro);
		listaVacia.add(manuel);
		listaVacia.add(ernesto);
		listaVacia.add(manuel);
